...
with tab1:
    ...
    with st.form("my_form"):
            ...
            if submit_button and flag==0:
                import pickle
                with open(r"C:\Users\BALA SAKTHI\Desktop\Projects\model.pkl", 'rb') as file:
                    loaded_model = pickle.load(file)
                with open(r'C:\Users\BALA SAKTHI\Desktop\Projects\scaler.pkl', 'rb') as f:
                    scaler_loaded = pickle.load(f)

                with open(r"C:\Users\BALA SAKTHI\Desktop\Projects\t.pkl", 'rb') as f:
                    t_loaded = pickle.load(f)

                with open(r"C:\Users\BALA SAKTHI\Desktop\Projects\s.pkl", 'rb') as f:
...
with tab2:
        ...
        with st.form("my_form1"):
            ...
            if csubmit_button and cflag==0:
                import pickle
                with open(r"C:\Users\BALA SAKTHI\Desktop\Projects\cmodel.pkl", 'rb') as file:
                    cloaded_model = pickle.load(file)

                with open(r'C:\Users\BALA SAKTHI\Desktop\Projects\cscaler.pkl', 'rb') as f:
                    cscaler_loaded = pickle.load(f)

                with open(r"C:\Users\BALA SAKTHI\Desktop\Projects\ct.pkl", 'rb') as f:
                ...
                st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Balasakthivelpandi</h6>', unsafe_allow_html=True )  
